...
public class NavActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.container,new MapFragments()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.map) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.container,new BookRawMaterialsFragment()).commit();
